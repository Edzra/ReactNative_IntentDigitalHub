...
export default class XmlStoreService{
    ...
    public static allocateXmls() : void{
        let xmlFiles: Array<XmlFile> = [XmlFile.XML_NFCE, XmlFile.XML_SAT, XmlFile.XML_SAT_CANCELAMENTO, XmlFile.SAT_ENVIAR_DADOS_VENDA, XmlFile.SAT_GO_ENVIAR_DADOS_VENDA];

        for(let xmlFile of xmlFiles){
            NativeServiceInterface.storeXmlFile(xmlFile.XmlContentInString, xmlFile.xmlArchiveName)
        }
    }
}