...
export default class XmlFile {
    ...
    public static readonly XML_NFCE: XmlFile = new XmlFile(new XmlNfce().getXml(), 'xmlnfce');
    public static readonly XML_SAT: XmlFile = new XmlFile(new XmlSat().getXml(), 'xmlsat');
    public static readonly XML_SAT_CANCELAMENTO: XmlFile = new XmlFile(new XmlSatCancelamento().getXml(), 'xmlsatcancelamento');
    //Xmls usados no módulo SAT
    public static readonly SAT_ENVIAR_DADOS_VENDA: XmlFile = new XmlFile(new SatXmlEnviarDadosVenda().getXml(), 'sat_enviar_dados_venda');
    public static readonly SAT_GO_ENVIAR_DADOS_VENDA: XmlFile = new XmlFile(new SatGoXmlEnviarDadosVenda().getXml(), 'satgo_enviar_dados_venda');
     ...
     */
    private constructor(public readonly XmlContentInString: string, public readonly xmlArchiveName: string){}
}